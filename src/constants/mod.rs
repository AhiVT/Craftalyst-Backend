...
pub const EMBED_FOOTER: &str = "Bot by Ahi#0001";
...
pub const PUBLIC_SHAMING_TITLE: &str = "Ahi pls fix sis blease";
...
pub const STEAM_FAIL_CONTACT: &str = "Unable to contact Craftalyst Services.";
...
pub const MC_CHANNEL_ID: u64 = 1_058_868_409_732_972_574;
